    ...
    <div class="content-box-content  clearfix" id="wrapper">
        ...
        <div id="listview-wrapper" class="left">
            <?php  $this->widget('zii.widgets.CListView', array(
                                                ...
                                                'itemView' => 'application.views.classroom._view',
                                                'id' => 'classroom-listview',
                    ...
                    "ajax" : {
                        ...
                        complete : function() {
                            $(".category_name").bind('click', function() {
                                ...
                                $.fn.yiiListView.update("classroom-listview",
                                        {'data':{'cat_id':pk},
                                            'complete':function() {
...
//Update
    ...
    $.bind_crud = function() {
        ...
        $('a.update_classroom').bind('click', function() {
            $.ajax({
                type: "POST",
                url: "/Cody/classroom/returnProductForm/",
                    ...
                    $.fancybox(data,
                            {    "transitionIn"    :    "elastic",
                                ...
                                "beforeClose":    function() {
                                    ...
                                    $.fn.yiiListView.update("classroom-listview", {'data':{'cat_id':cat_pk}
...
//View
        $('a.classroom_properties').bind('click', function() {
            $.ajax({
                type: "POST",
...
//DELETE  PRODUCT BINDING
        $('a.delete_classroom').bind('click', function() {
            ...
            var dlg = $('<div title="Delete Confirmation">\n\
                     <span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>\n\
                     Classroom <span style="color:#FF73B4;font-weight:bold;">' + product_title + '  (ID:  ' + product_id + '  )</span> will be deleted.Are you sure?</div>');
            var options = {
                resizable: false,
                height:170,
...
//REFRESH JSTREE
    ...
    $("#all").click(function () {
        $.fn.yiiListView.update("classroom-listview", {'data':{'cat_id':'all'}});
