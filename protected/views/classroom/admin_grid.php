...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content  clearfix" id="wrapper">
        <ul>
           ...
           <p>Click on a classroom node  to filter Student records</p>
        <div style="margin-bottom: 70px;">
            <div style="float:left">
                <input id="reload" type="button" style="display:block; clear: both;" value="Refresh Classroom"
                       class="client-val-form button">
            </div>
            <div style="float:left">
                <input id="add_root" type="button" style="display:block; clear: both;" value="Create Root Classroom"
                       class="client-val-form button">
            </div>
       ...
       <div id="<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>"  class="left" >
        </div>

        <div id='category_info'>
            <div id='pic'>    </div>
            <div id='title'>
                                <h3><?php echo Classroom::model()->findByPK($category_id)->name;?></h3>
                            </div>
        </div>
...
$(function () {
    ...
    $("#<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>")
            .jstree({
                "html_data" : {
                    "ajax" : {
                        "type":"POST",
                        "url" : "<?php echo $baseUrl;?>/classroom/fetchTree",
                        "data" : function (n) {
                            return {
                ...
                "contextmenu":  { 'items': {
                    ...
                    "update" : {
                        ...
                        "action"    : function (obj) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $baseUrl;?>/classroom/returnForm",
                                data:{
                                    'update_id':  id,
                                    "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                },
                                'beforeSend' : function() {
                                    $("#<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>").addClass("ajax-sending");
                                },
                                'complete' : function() {

                                    $("#<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>").removeClass("ajax-sending");
                                    ...
                                    $.fancybox(data,
                                            {    "transitionIn"    :    "elastic",
                                                ...
                                                "beforeClose":    function() {
                                                    ...
                                                    jQuery("#<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>").jstree("refresh");
                                                    $.fn.yiiGridView.update("student-grid");
                    ...
                    "properties" : {
                        ...
                        "action" : function (obj) {
                            ...
                            $.ajax({
                                type:"POST",
                                url:"<?php echo $baseUrl;?>/classroom/returnView",
                                data:   {
                                    "id" :id,
                                    "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                },
                   ...
                   Classroom <span style="color:#FF73B4;font-weight:bold;">' + (obj).attr('rel') + '</span> and all it\'s subcategories will be deleted.Are you sure?</div>')
                                    .dialog({
                                        resizable: false,
                                        height:170,
                                        modal: true,
                                        buttons: {
                                            "Delete": function() {
                                                jQuery("#<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>").jstree("remove", obj);
                                                $(this).dialog("close");
                                            },
                                            Cancel: function() {
                                                $(this).dialog("close");
        ...
        ///EVENTS
            .bind("rename.jstree", function (e, data) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo $baseUrl;?>/classroom/rename",
                    data:  {
            ...
            .bind("remove.jstree", function (e, data) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo $baseUrl;?>/classroom/remove",
                    data:{
                        "id" : data.rslt.obj.attr("id").replace("node_", ""),
                        "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                    },
            ...
            .bind("move_node.jstree", function (e, data) {
                data.rslt.o.each(function (i) {
                    ...
                    next = jQuery.jstree._reference('#<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>')._get_next(this, true);
                    previous = jQuery.jstree._reference('#<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>')._get_prev(this, true);
...
//                      console.log(replaced_node,'REPLACED NODE');
                    ...
                    $.ajax({
                        async : false,
                        type: 'POST',
                        url: "<?php echo $baseUrl;?>/classroom/moveCopy",
...
// DELETE
    ...
    //Binding events for Classroom refresh, add root,add Student  buttons
