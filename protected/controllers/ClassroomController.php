 ...
 * ClassroomController * InfoWebSphere {@link http://libkal.gr/infowebsphere}
...
class ClassroomController extends GxController {
  ...
  $this->render('admin_list', array(
   ...
   //prepare dataproviders  for Category and Product models
    ...
    private function prepare_dataproviders()
    {
        ...
        $prod_criteria->with = array('assignments' => array(
            'on' => 'assignments.id=:cat_id',
            'together' => true,
            'joinType' => 'INNER JOIN',
...
/**
   ...
   public function actionRename(){
    ...
    public function actionReturnForm()
    {
        ...
        if (isset($_POST['update_id'])) $model = $this->loadModel($_POST['update_id']); else $model = new Classroom;
     ...
     public function actionCreateRoot()
    {
        if (isset($_POST['Classroom'])) {
            ...
            $relatedData = array(
                'students' => $_POST['Classroom']['students'] === '' ? null : $_POST['Classroom']['students'],
            );
    ...
    public function actionUpdate()
    {
        ...
        if (isset($_POST['Classroom'])) {
            ...
            if ($model->saveNodeWithRelated(array('students' => $_POST['Classroom']['students']), false)) {
                echo json_encode(array('success' => true,
                                      'update_id' => $_POST['update_id'],
                                      'updated_name' => $model->name,
                                      'updated_img' => $model->classroomImgBehavior->getFileUrl('thumb')));
            }
