...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
        <h2>Students</h2><br>
        <h3>Administration with GridView</h3>
    ...
    <div class="content-box-content  clearfix" id="wrapper">
        <ul>
           ...
           <p>Click on a student node  to filter Classroom records</p>
        <div style="margin-bottom: 70px;">
            <div style="float:left">
                <input id="reload" type="button" style="display:block; clear: both;" value="Refresh Student"
                       class="client-val-form button">
            </div>
            <div style="float:left">
                <input id="add_root" type="button" style="display:block; clear: both;" value="Create Root Student"
                       class="client-val-form button">
            </div>
            <div style="float:right">
                <input id="add_classroom" type="button" style="display:block; clear: both;" value="New Classroom"
                       class="client-val-form button">
            </div>
            <div style="float:left">
                <input id="all" type="button" style="display:block; clear: both;" value="All Classrooms"
                       class="client-val-form button">
            </div>
        </div>
       ...
       <div id="<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>"  class="left" >
        </div>

        <div id='category_info'>
            <div id='pic'>    </div>
            <div id='title'>
                                <h3><?php echo Student::model()->findByPK($category_id)->name;?></h3>
                            </div>
        </div>
...
");?>
        ...
        <a class="search-button" href="#">Advanced Search</a>        <div class="search-form hide">
            <?php $this->renderPartial('application.views.classroom._search', array(
                                                                                 'model' => $model,
                                                                            )); ?>        </div>
        <!-- search-form -->
     ...
     <?php          
        ...
        $del_con = Yii::t('admin_classroom', 'Are you sure you want to delete this classroom?');
        $del_title = Yii::t('admin_classroom', 'Delete Confirmation');
        $del = Yii::t('admin_classroom', 'Delete');
        $cancel = Yii::t('admin_classroom', 'Cancel')
	...
	'columns' => array(
		...
		'price',
                   array(
                                                                                  'class' => 'CDataColumn',
                                                                                  'type' => 'image',
                                                                                  'value' => '($data->classroomImgBehavior->getFileUrl("small"))?$data->classroomImgBehavior->getFileUrl("small")."?".time() :Yii::app()->baseUrl."/img/placeholder_50.jpg". "?".time()',
                                                                              ),

		array(
                                                                           'class' => 'CButtonColumn',
                                                                           'buttons' => array(
                                                                               'classroom_delete' => array(
                                                                                   'label' => Yii::t('admin_classroom', 'Delete'), // text label of the button
                                                                               ...
                                                                               'classroom_update' => array(
                                                                                   'label' => Yii::t('admin_classroom', 'Update'), // text label of the button
                                                                                   'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                                               ...
                                                                               'classroom_view' => array(
                                                                                   'label' => Yii::t('admin_classroom', 'View'), // text label of the button
                                                                                   'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                                           ...
                                                                           'template' => '{classroom_view}{classroom_update}{classroom_delete}',
                                                                       ),
	),
...
$(function () {
    ...
    $("#<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>")
            .jstree({
                "html_data" : {
                    "ajax" : {
                        "type":"POST",
                        "url" : "<?php echo $baseUrl;?>/student/fetchTree",
                        "data" : function (n) {
                            return {
                ...
                "contextmenu":  { 'items': {
                    ...
                    "update" : {
                        ...
                        "action"    : function (obj) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $baseUrl;?>/student/returnForm",
                                data:{
                                    'update_id':  id,
                                    "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                },
                                'beforeSend' : function() {
                                    $("#<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>").addClass("ajax-sending");
                                },
                                'complete' : function() {

                                    $("#<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>").removeClass("ajax-sending");
                                    ...
                                    $.fancybox(data,
                                            {    "transitionIn"    :    "elastic",
                                                ...
                                                "beforeClose":    function() {
                                                    ...
                                                    jQuery("#<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>").jstree("refresh");
                                                    $.fn.yiiGridView.update("classroom-grid");
                    ...
                    "properties" : {
                        ...
                        "action" : function (obj) {
                            ...
                            $.ajax({
                                type:"POST",
                                url:"<?php echo $baseUrl;?>/student/returnView",
                                data:   {
                                    "id" :id,
                                    "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                },
                   ...
                   Student <span style="color:#FF73B4;font-weight:bold;">' + (obj).attr('rel') + '</span> and all it\'s subcategories will be deleted.Are you sure?</div>')
                                    .dialog({
                                        resizable: false,
                                        height:170,
                                        modal: true,
                                        buttons: {
                                            "Delete": function() {
                                                jQuery("#<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>").jstree("remove", obj);
                                                $(this).dialog("close");
                                            },
                                            Cancel: function() {
                                                $(this).dialog("close");
        ...
        ///EVENTS
            .bind("rename.jstree", function (e, data) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo $baseUrl;?>/student/rename",
                    data:  {
            ...
            .bind("remove.jstree", function (e, data) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo $baseUrl;?>/student/remove",
                    data:{
                        "id" : data.rslt.obj.attr("id").replace("node_", ""),
                        "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                    },
            ...
            .bind("move_node.jstree", function (e, data) {
                data.rslt.o.each(function (i) {
                    ...
                    next = jQuery.jstree._reference('#<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>')._get_next(this, true);
                    previous = jQuery.jstree._reference('#<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>')._get_prev(this, true);
...
//                      console.log(replaced_node,'REPLACED NODE');
                    ...
                    $.ajax({
                        async : false,
                        type: 'POST',
                        url: "<?php echo $baseUrl;?>/student/moveCopy",
    ...
    $.bind_crud = function() {
        ...
        $('.fan_view').each(function(index) {
            ...
            $(this).bind('click', function() {
                $.ajax({
                    type: "POST",
                    url: "<?php echo $baseUrl;?>/classroom/returnProductView",
                    data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                        $("#classroom-grid").addClass("ajax-sending");
                    },
                    complete : function() {
                        $("#classroom-grid").removeClass("ajax-sending");
                    },
                    success: function(data) {
                        $.fancybox(data,
                                {    "transitionIn" : "elastic",
...
//UPDATE
        ...
        $('.fan_update').each(function(index) {
            ...
            $(this).bind('click', function() {
                $.ajax({
                    type: "POST",
                    url: "<?php echo $baseUrl;?>/classroom/returnProductForm",
                        ...
                        $.fancybox(data,
                                {    "transitionIn"    :  "elastic",
                                    ...
                                    "beforeClose":    function() {
                                        ...
                                        $.fn.yiiGridView.update("classroom-grid", {'data':{'cat_id':cat_pk}});
                                    }//onclosed
                                });//fancybox
                        //  console.log(data);
                    } //success
...
// DELETE
        ...
        $('.fan_del').each(function(index) {
            ...
            deletes[id] = function() {
                $.ajax({
                    type: "POST",
                    url: "<?php echo $baseUrl;?>/classroom/delete",
                    data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                        $("#classroom-grid").addClass("ajax-sending");
                    },
    ...
    //Binding events for Student refresh, add root,add Classroom  buttons
...
//REFRESH JSTREE
    ...
    $("#all").click(function () {
        $.fn.yiiGridView.update("classroom-grid", {'data':{'cat_id':'all'}});
        $('#title > h3').html('All Classrooms');
        $('#pic').html('');
    });
