...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
       <h2>Students</h2><br>
        ...
        <a   class='headerlinks' href="<?php echo $this->createUrl('index_list');?>">Frontend ListView</a>
         <br>
        <p>Right click on a student node  for details.Click on a student node  to filter Classroom records.</p>
    </div>
    ...
    <div class="content-box-content  clearfix" id="wrapper">
        ...
        <div style="float:left">
            <input id="reload" type="button" style="display:block; clear: both;" value="Refresh Students"
        ...
        <div id="<?php echo Student::ADMIN_TREE_CONTAINER_ID;?>" class="admintree">
        </div>
