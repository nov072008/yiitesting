 ...
 *  _frontend_view.php   partial view for rendering  grade *    records  in ListView,in frontend views.
...
$thumb_src=$data->gradeImgBehavior->getFileUrl('thumb');
...
<div class="list_partial_view">
    ...
    <div class='clear'>
        <?php echo GxHtml::encode($data->getAttributeLabel('name        ')); ?>:
                ...
                <br/>
                <?php echo GxHtml::encode($data->getAttributeLabel('letter        ')); ?>:
                <?php echo GxHtml::encode($data->letter); ?>
                <br/>
                <?php echo GxHtml::encode($data->getAttributeLabel('assignmentid        ')); ?>:
                <?php echo GxHtml::encode($data->assignmentid); ?>
                <br/>
            </div>
    <div class="crud_buttons">
        <a id="view_<?php echo $data->id;?>"
           class="grade_properties"
