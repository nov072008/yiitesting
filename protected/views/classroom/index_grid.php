...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
       <h2>Classrooms</h2><br>
        ...
        <a   class='headerlinks' href="<?php echo $this->createUrl('index_list');?>">Frontend ListView</a>
         <br>
        <p>Right click on a classroom node  for details.Click on a classroom node  to filter Student records.</p>
    </div>
    ...
    <div class="content-box-content  clearfix" id="wrapper">
        ...
        <div style="float:left">
            <input id="reload" type="button" style="display:block; clear: both;" value="Refresh Classrooms"
        ...
        <div id="<?php echo Classroom::ADMIN_TREE_CONTAINER_ID;?>" class="admintree">
        </div>
