...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
       <h2>Assignments</h2><br>
        ...
        <a   class='headerlinks' href="<?php echo $this->createUrl('index_list');?>">Frontend ListView</a>
         <br>
        <p>Right click on a assignment node  for details.Click on a assignment node  to filter Student records.</p>
    </div>
    ...
    <div class="content-box-content  clearfix" id="wrapper">
        ...
        <div style="float:left">
            <input id="reload" type="button" style="display:block; clear: both;" value="Refresh Assignments"
        ...
        <div id="<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>" class="admintree">
        </div>
