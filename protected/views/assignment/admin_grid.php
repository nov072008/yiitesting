...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content  clearfix" id="wrapper">
        <ul>
           ...
           <p>Click on a assignment node  to filter Student records</p>
        <div style="margin-bottom: 70px;">
            <div style="float:left">
                <input id="reload" type="button" style="display:block; clear: both;" value="Refresh Assignment"
                       class="client-val-form button">
            </div>
            <div style="float:left">
                <input id="add_root" type="button" style="display:block; clear: both;" value="Create Root Assignment"
                       class="client-val-form button">
            </div>
            <div style="float:right">
                <input id="add_student" type="button" style="display:block; clear: both;" value="New Student"
                       class="client-val-form button">
            </div>
            <div style="float:left">
                <input id="all" type="button" style="display:block; clear: both;" value="All Students"
                       class="client-val-form button">
            </div>
        </div>
       ...
       <div id="<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>"  class="left" >
        </div>

        <div id='category_info'>
            <div id='pic'>    </div>
            <div id='title'>
                                <h3><?php echo Assignment::model()->findByPK($category_id)->name;?></h3>
                            </div>
        </div>
...
");?>
        ...
        <a class="search-button" href="#">Advanced Search</a>        <div class="search-form hide">
            <?php $this->renderPartial('application.views.student._search', array(
                                                                                 'model' => $model,
                                                                            )); ?>        </div>
        <!-- search-form -->
     ...
     <?php          
        ...
        $del_con = Yii::t('admin_student', 'Are you sure you want to delete this student?');
        $del_title = Yii::t('admin_student', 'Delete Confirmation');
        $del = Yii::t('admin_student', 'Delete');
        $cancel = Yii::t('admin_student', 'Cancel')
	...
	'columns' => array(
		...
		'gradelevel',
                   array(
                                                                                  'class' => 'CDataColumn',
                                                                                  'type' => 'image',
                                                                                  'value' => '($data->studentImgBehavior->getFileUrl("small"))?$data->studentImgBehavior->getFileUrl("small")."?".time() :Yii::app()->baseUrl."/img/placeholder_50.jpg". "?".time()',
                                                                              ),
		...
		array(
                                                                           ...
                                                                           'buttons' => array(
                                                                               'student_delete' => array(
                                                                                   'label' => Yii::t('admin_student', 'Delete'), // text label of the button
                                                                               ...
                                                                               'student_update' => array(
                                                                                   'label' => Yii::t('admin_student', 'Update'), // text label of the button
                                                                                   'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                                               ...
                                                                               'student_view' => array(
                                                                                   'label' => Yii::t('admin_student', 'View'), // text label of the button
                                                                                   'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                                           ...
                                                                           'template' => '{student_view}{student_update}{student_delete}',
                                                                       ),
	),
...
$(function () {
    ...
    $("#<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>")
            .jstree({
                "html_data" : {
                    "ajax" : {
                        "type":"POST",
                        "url" : "<?php echo $baseUrl;?>/assignment/fetchTree",
                        "data" : function (n) {
                            return {
                ...
                "contextmenu":  { 'items': {
                    ...
                    "update" : {
                        ...
                        "action"    : function (obj) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $baseUrl;?>/assignment/returnForm",
                                data:{
                                    'update_id':  id,
                                    "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                },
                                'beforeSend' : function() {
                                    $("#<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>").addClass("ajax-sending");
                                },
                                'complete' : function() {

                                    $("#<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>").removeClass("ajax-sending");
                                    ...
                                    $.fancybox(data,
                                            {    "transitionIn"    :    "elastic",
                                                ...
                                                "beforeClose":    function() {
                                                    ...
                                                    jQuery("#<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>").jstree("refresh");
                                                    $.fn.yiiGridView.update("student-grid");
                    ...
                    "properties" : {
                        ...
                        "action" : function (obj) {
                            ...
                            $.ajax({
                                type:"POST",
                                url:"<?php echo $baseUrl;?>/assignment/returnView",
                                data:   {
                                    "id" :id,
                                    "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                },
                   ...
                   Assignment <span style="color:#FF73B4;font-weight:bold;">' + (obj).attr('rel') + '</span> and all it\'s subcategories will be deleted.Are you sure?</div>')
                                    .dialog({
                                        resizable: false,
                                        height:170,
                                        modal: true,
                                        buttons: {
                                            "Delete": function() {
                                                jQuery("#<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>").jstree("remove", obj);
                                                $(this).dialog("close");
                                            },
                                            Cancel: function() {
                                                $(this).dialog("close");
        ...
        ///EVENTS
            .bind("rename.jstree", function (e, data) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo $baseUrl;?>/assignment/rename",
                    data:  {
            ...
            .bind("remove.jstree", function (e, data) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo $baseUrl;?>/assignment/remove",
                    data:{
                        "id" : data.rslt.obj.attr("id").replace("node_", ""),
                        "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                    },
            ...
            .bind("move_node.jstree", function (e, data) {
                data.rslt.o.each(function (i) {
                    ...
                    next = jQuery.jstree._reference('#<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>')._get_next(this, true);
                    previous = jQuery.jstree._reference('#<?php echo Assignment::ADMIN_TREE_CONTAINER_ID;?>')._get_prev(this, true);
...
//                      console.log(replaced_node,'REPLACED NODE');
                    ...
                    $.ajax({
                        async : false,
                        type: 'POST',
                        url: "<?php echo $baseUrl;?>/assignment/moveCopy",
    ...
    $.bind_crud = function() {
        ...
        $('.fan_view').each(function(index) {
            ...
            $(this).bind('click', function() {
                $.ajax({
                    type: "POST",
                    url: "<?php echo $baseUrl;?>/student/returnProductView",
                    data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                        $("#student-grid").addClass("ajax-sending");
                    },
                    complete : function() {
                        $("#student-grid").removeClass("ajax-sending");
                    },
                    success: function(data) {
                        $.fancybox(data,
                                {    "transitionIn" : "elastic",
...
//UPDATE
        ...
        $('.fan_update').each(function(index) {
            ...
            $(this).bind('click', function() {
                $.ajax({
                    type: "POST",
                    url: "<?php echo $baseUrl;?>/student/returnProductForm",
                        ...
                        $.fancybox(data,
                                {    "transitionIn"    :  "elastic",
                                    ...
                                    "beforeClose":    function() {
                                        ...
                                        $.fn.yiiGridView.update("student-grid", {'data':{'cat_id':cat_pk}});
                                    }//onclosed
                                });//fancybox
                        //  console.log(data);
                    } //success
...
// DELETE
        ...
        $('.fan_del').each(function(index) {
            ...
            deletes[id] = function() {
                $.ajax({
                    type: "POST",
                    url: "<?php echo $baseUrl;?>/student/delete",
                    data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                        $("#student-grid").addClass("ajax-sending");
                    },
    ...
    //Binding events for Assignment refresh, add root,add Student  buttons
...
//REFRESH JSTREE
    ...
    $("#all").click(function () {
        $.fn.yiiGridView.update("student-grid", {'data':{'cat_id':'all'}});
        $('#title > h3').html('All Students');
        $('#pic').html('');
    });
