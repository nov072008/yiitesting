 ...
 *  view.php   detailed view for classroom * InfoWebSphere {@link http://libkal.gr/infowebsphere}
...
$large_src = $model->classroomImgBehavior->getFileUrl('large');
...
array(
			'name' => 'teacher',
			'type' => 'raw',
			'value' => $model->teacher !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->teacher)), array('user/view', 'id' => GxActiveRecord::extractPkValue($model->teacher, true))) : null,
			),
	),
)); ?>
